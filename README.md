...
## 💡 Ejemplos de Consultas / Query Examples / Exemples de Requêtes

Puedes probar escribiendo directamente términos clave o preguntas naturales en la barra de búsqueda:

### 🇪🇸 Español

- `Harry Kane` _(Ficha del jugador)_
...
- `Harry Kane` _(Fiche du joueur)_
